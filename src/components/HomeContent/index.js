        ...
        <div className="flex flex-wrap w-full">
          <div className="md:w-1/2 pr-5 pl-5">
            ...
            <div className='text-gray-100 sm:mb-5'>
              ...
              <h3 className='text-xl mt-4'><Translate>Dynamic Combat System In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Transformation Abilities In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Comprehensive Character Progression In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Impressive Boss Battles In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Rich Exploration Elements In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Stunning Visual Effects In Black Myth: Wukong</Translate></h3>
              ...
              <h3 className='text-xl mt-4'><Translate>Rich Cultural Depth In Black Myth: Wukong</Translate></h3>
